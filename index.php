...
<body class="bg-gradient-login" style="background-image: url('img/logo/bb.jpg');">
  <!-- Login Content -->
...
?>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="font-weight-bold small" href="EmployeeLogin.php" style="align: center;">Employee Login!</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
