  ...
  <link href="css/ruang-admin.min.css" rel="stylesheet">
   ...
   <script>
    ...
    if (str == "") {
        ...
        xmlhttp.open("GET","ajaxEmployeeId.php?cid="+str,true);
        xmlhttp.send();
    }
}
</script>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Create Create Employee</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Create Create Employee ID</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                   <div class="form-group row mb-3">
                    ...
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">Select Employee Name<span class="text-danger ml-2">*</span></label>
                         <?php
