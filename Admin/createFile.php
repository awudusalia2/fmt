...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"insert into tblstudents(firstName,admissionNumber,password,classId,classArmId,dateCreated) 
    value('$firstName','$admissionNumber','12345','$classId','$classArmId','$dateCreated')");
...
<head>
  ...
  <link href="img/logo/dd.png" rel="icon">
  ...
  <link href="css/ruang-admin.min.css" rel="stylesheet">
   ...
   <script>
    ...
    if (str == "") {
        ...
        xmlhttp.open("GET","ajaxEmployeeId2.php?cid="+str,true);
        xmlhttp.send();
    }
}
</script>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Create File</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                   <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">Filename<span class="text-danger ml-2">*</span></label>
                        <input type="text" class="form-control" name="firstName" value="<?php echo $row['firstName'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">File Code<span class="text-danger ml-2">*</span></label>
                    ...
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">Select Employee<span class="text-danger ml-2">*</span></label>
                         <?php
                        ...
                        <div class="col-xl-6">
                        <label class="form-control-label">Employee ID<span class="text-danger ml-2">*</span></label>
                            <?php
